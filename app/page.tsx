  ...
  return (
    <main className="flex flex-col items-center p-8 md:p-24">
      <div className="flex flex-col items-start space-y-12">
          ...
          >
            ...
            >
              <g clip-path="url(#a)">
                <path
                  fill="#1ED760"
                  d="M18.992 10.659C15.182 8.396 8.898 8.189 5.26 9.292a1.105 1.105 0 1 1-.642-2.116C8.794 5.91 15.734 6.154 20.12 8.757a1.106 1.106 0 0 1-1.128 1.902Zm-.125 3.35a.922.922 0 0 1-1.268.304c-3.176-1.952-8.02-2.518-11.777-1.377a.923.923 0 0 1-1.15-.614.923.923 0 0 1 .615-1.15c4.292-1.302 9.629-.67 13.277 1.571.433.267.57.834.303 1.267Zm-1.446 3.22a.736.736 0 0 1-1.013.244c-2.776-1.696-6.27-2.079-10.383-1.14a.736.736 0 1 1-.328-1.435c4.502-1.03 8.364-.586 11.48 1.317a.737.737 0 0 1 .244 1.013ZM12 .18C5.472.181.18 5.473.18 12c0 6.528 5.292 11.82 11.82 11.82 6.527 0 11.818-5.292 11.818-11.82C23.82 5.473 18.528.18 12 .18Z"
                />
              </g>
              <defs>
                <clipPath id="a">
        ...
        <a
          href="mailto:iandgoode@gmail.com"
          class="flex flex-none basis-auto items-center gap-3 rounded-lg bg-white px-4 py-3 text-sm hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-600 dark:bg-dark-base dark:bg-dark-base dark:text-white dark:hover:bg-dark-highlight dark:focus:ring-gray-300"
        >
          <svg
