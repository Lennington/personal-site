    ...
    <main className="flex flex-col items-center p-8 md:p-24">
      ...
      <div className="flex flex-col space-y-12 items-start">
        ...
        <p className="md:text-xl max-w-3xl leading-relaxed">I’m a Product Designer at {' '}
          <a href="https://open.spotify.com" target="_blank" className="inline-flex gap-x-2 items-center font-bold leading-none align-text-top decoration-spotify underline-offset-4 decoration-2 underline hover:text-white">
        ...
        <p className="md:text-xl max-w-3xl leading-relaxed">Before Spotify, I led design at {' '}
          <a href="https://www.kinzen.com/" target="_blank" className="inline-flex gap-x-2 items-center font-bold leading-none align-text-top decoration-kinzen underline-offset-4 decoration-2 underline hover:text-white">
            <svg xmlns="http://www.w3.org/2000/svg" width="23" height="24" fill="none"><path fill="#fff" fill-rule="evenodd" d="m22.04 5.386.709 1.215-9.343 5.395 9.343 5.394-.71 1.215-9.334-5.394V24h-1.41V0h1.41v10.78l9.334-5.394ZM6.611 1.257l-1.214.701 3.385 5.863 1.213-.701-3.384-5.863ZM0 11.294h6.77v1.402H0v-1.402ZM7.114 14l-5.862 3.385.7 1.214 5.863-3.385-.7-1.214ZM5.38 22.04l3.385-5.863v.002l1.214.7-3.385 5.863-1.214-.702ZM1.26 6.605l.702-1.215 5.863 3.386-.702 1.213-5.862-3.384Z" clip-rule="evenodd"/></svg>
            Kinzen
          </a>
          , where I helped global platforms keep their communities safe from harmful content. Kinzen was acquired by Spotify in 2022.
        </p>

        <p className="md:text-xl max-w-3xl leading-relaxed">Before Kinzen, I led the design team at {' '}
          <a href="https://www.axonista.com/" target="_blank" className="inline-flex gap-x-2 items-center font-bold leading-none align-text-top decoration-axonista underline-offset-4 decoration-2 underline hover:text-white">
          ...
          , worked on a platform to power interactive video experiences, and designed video apps for global brands.
        </p>

        <a href="mailto:iandgoode@gmail.com" class="flex flex-none basis-auto items-center gap-3 bg-darkGrey-base focus:outline-none focus:ring-2 focus:ring-gray-300 rounded-lg px-4 py-3 text-sm dark:bg-darkGrey-base dark:text-white dark:hover:bg-darkGrey-highlight dark:focus:ring-gray-600">
